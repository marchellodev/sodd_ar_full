 ...
 */
package ua.int20h.sodd_warriors.ar_task.ar;
...
public class BeyondarObjectMod implements Plugable<BeyondarObjectPlugin> {
    ...
    /**
     * Create an instance of a {@link BeyondarObjectMod
     ...
     * the {@link BeyondarObjectMod BeyondarObject}
     * unique id.
     */
     ...
     * {@link BeyondarObjectMod BeyondarObject}.
     */
    public long getId() {
        if (mId == null) {
            mId = (long) hashCode();
     ...
     * {@link BeyondarObjectMod BeyondarObject}.
     *
     * @param x The angle in degrees for x.
     * @param y The angle in degrees for y.
     * @param z The angle in degrees for z.
     */
     ...
     * {@link BeyondarObjectMod BeyondarObject} is being
     * rendered.
     *
     ...
     * to render the {@link BeyondarObjectMod
     * BeyondarObject}.
     *
     ...
     * {@link BeyondarObjectMod BeyondarObject}.
     *
     * @param texturePointer The new texture pointer.
     */
     ...
     * that renders the {@link BeyondarObjectMod
     * BeyondarObject}
     *
     ...
     * Renderable} for the {@link BeyondarObjectMod
     * BeyondarObject}
     *
     * @param renderable
     */
     ...
     * Set the image uri.
     *
     * @param uri The image uri that represents the
     *            {@link BeyondarObjectMod
     *            BeyondarObject}.
     */
    ...
    /**
     * Define if the {@link BeyondarObjectMod
     * BeyondarObject} should face the camera.
     *
     * @param faceToCamera true if it should face the camera, false otherwise.
     */
    ...
    /**
     * Check if the {@link BeyondarObjectMod
     ...
     * render it.
     *
     * @param visible True to set it visible, false to don't render it.
     */
    ...
    /**
     * Get the name of the {@link BeyondarObjectMod
     * BeyondarObject}.
     *
     * @return The name of the {@link BeyondarObjectMod
     * BeyondarObject}.
     */
    ...
    /**
     * Set the name of the {@link BeyondarObjectMod
     * BeyondarObject}.
     *
     * @param name Name of the {@link BeyondarObjectMod
     *             BeyondarObject}.
     */
     ...
     * {@link BeyondarObjectMod BeyondarObject} on the
    ...
    /**
     * Get the top left of the {@link BeyondarObjectMod
