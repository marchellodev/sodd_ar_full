...
public class ArBeyondarGLSurfaceView extends GLSurfaceView implements OnBeyondarObjectRenderedListener {
     ...
     *
     * @param fpsUpdatable The event listener. Use null to remove the
     *                     {@link FpsUpdatable
     *                     FpsUpdatable}
     */
    ...
    public void setVisibility(int visibility) {
        mRenderer.setRendering(visibility == VISIBLE);
     ...
     * @param x
     * @param y
     * @param beyondarObjects The output list to place all the
     *                        {@link BeyondarObject
     ...
     * BeyondarObject.getScreenPositionTopRight()}
     *
     * @param beyondarObject The {@link BeyondarObject
